...
SELECT Typ, Name, Preis, Beschreibung FROM Speise WHERE Typ in('Vorspeise', 'Getränk') ORDER BY Typ;

SELECT Typ, Name, Preis, Beschreibung FROM Speise WHERE Typ != 'Getränk' ORDER BY Typ;
